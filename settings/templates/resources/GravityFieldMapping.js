...
jQuery.Class("Settings_GravityFieldMapping_Js",{
    ...
    triggerEdit : function(editUrl){
        ...
        AppConnector.request(editUrl).then(
            function(data) {
                ...
                var leadMappingInstance = new Settings_GravityFieldMapping_Js();
    ...
    registerEventsForEditView : function(){
        ...
        jQuery('select.contactFields.select2').trigger('change',false);
    },
    ...
    registerEventForAddingNewMapping : function(){
        jQuery('#addMapping').on('click',function(e){    
            ...
            if(!parseInt(lastSequenceNumber)){
            ...
            newMapping.find('select.contactFields.newSelect').attr("name",'mapping['+newSequenceNumber+'][gravity]');    
            ...
            app.showSelect2ElementView(select2Elements);
            jQuery('select.contactFields.select2',newMapping).trigger('change',false);
        })
    },
     ...
     */
    registerOnChangeEventForSourceModule11 : function(){
        var form = jQuery('#leadsMapping');
     ...
     */
    registerOnChangeEventOfTargetModule11 : function(){
        var form = jQuery('#leadsMapping');
